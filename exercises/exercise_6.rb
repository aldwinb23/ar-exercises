...
@store1.employees.create(first_name: "Joe", last_name: "Dirt", hourly_rate: 20)
@store1.employees.create(first_name: "Jim", last_name: "Bob", hourly_rate: 25)
...
@store2.employees.create(first_name: "Chef", last_name: "Boyardee", hourly_rate: 5)
@store2.employees.create(first_name: "Kraft", last_name: "Dinner", hourly_rate: 3)
